...
class LDAClustering():
    ...
    def pre_process_corpus(self, corpus_path, stopwords_path):
        ...
        :return:
        """
        with open(corpus_path, 'r', encoding='gbk'
                                             '') as f:
...
if __name__ == '__main__':
    ...
    ret = LDA.lda(r'C:\Users\Lu\PycharmProjects\DarkIndustry\dataset\sohu_train.txt', stopwords_path=r'C:\Users\Lu\PycharmProjects\DarkIndustry\dataset\stop_words.txt', max_iter=100, n_components=9)
    print(ret)